...
export interface SimpleAgricultureTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "areAssetsValid",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "assetExpiry",
    values: [AddressLike]
  ): string;
  encodeFunctionData(functionFragment: "assetType", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "assetVerificationStatus",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace AssetExpiredEvent {
...
export interface SimpleAgricultureToken extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleAgricultureToken;
  waitForDeployment(): Promise<this>;

  interface: SimpleAgricultureTokenInterface;
  ...
  areAssetsValid: TypedContractMethod<[holder: AddressLike], [boolean], "view">;

  assetExpiry: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;

  assetType: TypedContractMethod<[], [string], "view">;

  assetVerificationStatus: TypedContractMethod<
    [arg0: AddressLike],
    [boolean],
    "view"
  >;
  ...
  burnExpiredTokens: TypedContractMethod<
    [holder: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "areAssetsValid"
  ): TypedContractMethod<[holder: AddressLike], [boolean], "view">;
  getFunction(
    nameOrSignature: "assetExpiry"
  ): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "assetType"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "assetVerificationStatus"
  ...
  getEvent(
    ...
    AssetExpiredEvent.InputTuple,
    AssetExpiredEvent.OutputTuple,
  ...
  filters: {
    ...
    "AssetExpired(address,uint256)": TypedContractEvent<
      AssetExpiredEvent.InputTuple,
      AssetExpiredEvent.OutputTuple,
      AssetExpiredEvent.OutputObject
    >;
    AssetExpired: TypedContractEvent<
      AssetExpiredEvent.InputTuple,
      AssetExpiredEvent.OutputTuple,
      AssetExpiredEvent.OutputObject
    >;
